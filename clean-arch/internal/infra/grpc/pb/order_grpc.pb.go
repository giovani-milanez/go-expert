...
type OrderServiceClient interface {
	...
	ListOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrderResponse, error)
}
...
func (c *orderServiceClient) ListOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	ListOrder(context.Context, *Blank) (*ListOrderResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrder(context.Context, *Blank) (*ListOrderResponse, error) {

...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x17.pb.CreateOrderResponseR\x06orders2}\n" +
	"\fOrderService\x12>\n" +
	"\vCreateOrder\x12\x16.pb.CreateOrderRequest\x1a\x17.pb.CreateOrderResponse\x12-\n" +
	"\tListOrder\x12\t.pb.blank\x1a\x15.pb.ListOrderResponseB\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	2, // 0: pb.ListOrderResponse.orders:type_name -> pb.CreateOrderResponse
